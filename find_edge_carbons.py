...
def concave_hull(points, k):
    """Computes the polygon envelope of a 2D point set using the k nearest-neighbours approach. 
       ...
       -------
       hull_points: `ndarray`
            Coords of pts on the concave hull of the input point set. These points (and the lines between them)            best describe the boundary of the point set.
       """
...
if __name__ == "__main__":
    ...
    from inputoutput_nico import get_coords
    from protonate import get_most_edge_carbons
    ...
    pos_path = os.path.join(data_dir, '16x16_MAC_coords.xyz')
